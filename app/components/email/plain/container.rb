...
# Email::Plain::Container component [supports dark variant]
# REQUIRED: none
# NOTES:
# - Wraps all other components into an email layout
# - Plain::Container renders content on a plain @color container
#
#
# Example 1 (simple):
# <%= render Email::Plain::Container.new do |email| %>
#   ...
# <% end %>
#
class Email::Plain::Container < Email::Base
  ...
  erb_template <<~ERB
    ...
    <html xmlns="http://www.w3.org/1999/xhtml" xmlns="http://www.w3.org/1999/xhtml" style="color-scheme: light dark; supported-color-schemes: light dark;">
        ...
        <style type="text/css" rel="stylesheet" media="all">
          ...
          <% if @dark_mode_enabled %>
            @media (prefers-color-scheme: dark) {
              ...
              h3,
              span {
                color: color: <%= DarkStyles::CONTAINER_TEXT_COLOR %> !important;
              }
              .colorblock_content {
      ...
      <body style="width: 100% !important; height: 100%; -webkit-text-size-adjust: none; font-family: <%= @default_fonts %>; background-color: <%= @color %>; color: #333; margin: 0;" bgcolor="<%= @color %>">
        <table class="email-wrapper" width="100%" cellpadding="0" cellspacing="0" role="presentation" style="width: 100%; margin: 0; padding: 0;">
          <tr>
              ...
              <table class="email-content" width="100%" cellpadding="0" cellspacing="0" role="presentation" style="width: 100%; margin: 0; padding: 0;">
                ...
                <tr>
                  <td class="email-body" width="570" cellpadding="0" cellspacing="0" style="word-break: break-word; font-family: <%= @default_fonts %>; font-size: 16px; width: 100%; margin: 0; padding: 0;">
                    <table class="email-body_inner" align="center" width="570" cellpadding="0" cellspacing="0" role="presentation" style="width: 570px; min-width: 570px; max-width: 570px; margin: 0 auto; padding: 0;">
                      <!-- Body content -->
                      <tr>
