...
# Email::Full::Container component [supports dark variant]
# Wraps all other components into an email layout
# REQUIRED: none
# NOTES:
# - Omitting a ::Masthead component will render an empty space
# - Full::Container renders content on a full-width @color container, with a full-width @surrounds_color header
#
#
# Example 1 (simple):
# <%= render Email::Full::Container.new do |email| %>
#   ...
# <% end %>
#
class Email::Full::Container < Email::Base
          ...
          <tr>
            <td align="center" style="word-break: break-word; font-family: <%= @default_fonts %>; font-size: 16px;">
              <table class="email-content" width="100%" cellpadding="0" cellspacing="0" role="presentation" style="width: 100%; margin: 0; padding: 0;">
                ...
                <!-- Email Body -->
                <tr>
                  <td class="email-body" width="100%" cellpadding="0" cellspacing="0" style="word-break: break-word; font-family: <%= @default_fonts %>; font-size: 16px; width: 100%; background-color: <%= @color %>; margin: 0; padding: 0;" bgcolor="<%= @color %>">
                    <table class="email-body_inner" align="center" width="570" cellpadding="0" cellspacing="0" role="presentation" style="width: 570px; min-width: 570px; max-width: 570px; background-color: <%= @color %>; margin: 0 auto; padding: 0;" bgcolor="<%= @color %>">
                      <!-- Body content -->
                      <tr>
